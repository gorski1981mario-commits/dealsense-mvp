  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6' }}>
          Voor herroeping neem je contact op via <a href="mailto:info@dealsense.nl" style={{ color: '#1E7F5C', textDecoration: 'underline' }}>info@dealsense.nl</a>. 
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6' }}>
          Zie onze <a href="/veiligheid" style={{ color: '#1E7F5C', textDecoration: 'underline' }}>Privacy & Veiligheid pagina</a> voor meer informatie.
        </p>
      </div>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <ul style={{ fontSize: '14px', color: '#374151', lineHeight: '1.8', paddingLeft: '20px', marginBottom: '12px' }}>
          <li>Algemene vragen: <a href="mailto:info@dealsense.nl" style={{ color: '#1E7F5C', textDecoration: 'underline' }}>info@dealsense.nl</a></li>
          <li>Privacy gerelateerd: <a href="mailto:privacy@dealsense.nl" style={{ color: '#1E7F5C', textDecoration: 'underline' }}>privacy@dealsense.nl</a></li>
        </ul>
        <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6' }}>
