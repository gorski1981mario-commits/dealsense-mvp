...
import { Lock, Unlock, Download, Repeat, Tv } from 'lucide-react'
...
export default function SubscriptionsConfigurator({ packageType, userId }: SubscriptionsConfiguratorProps) {
  ...
  } = useConfigurationLock({ userId: userId || 'anonymous', sector: 'subscriptions' })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isLocked) {
      const parameters = { subscriptionType, services }
