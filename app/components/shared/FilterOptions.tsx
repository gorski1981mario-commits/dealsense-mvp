    ...
    <div style={{ 
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <label style={{ 
          ...
          border: selectedFilter === 'cheapest' ? '2px solid #1E7F5C' : '2px solid #E5E7EB',
          borderRadius: '10px',
        ...
        <label style={{ 
          ...
          border: selectedFilter === 'balanced' ? '2px solid #1E7F5C' : '2px solid #E5E7EB',
          borderRadius: '10px',
          cursor: disabled ? 'not-allowed' : 'pointer',
          transition: 'all 0.2s',
          opacity: disabled ? 0.6 : 1
        ...
        <label style={{ 
          ...
          border: selectedFilter === 'quality' ? '2px solid #1E7F5C' : '2px solid #E5E7EB',
          borderRadius: '10px',
          cursor: disabled ? 'not-allowed' : 'pointer',
          transition: 'all 0.2s',
          opacity: disabled ? 0.6 : 1
