        ...
        <div style={{ display: 'grid', gap: '16px' }}>
          <div style={{
            ...
            <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Zap size={20} strokeWidth={2} color="#15803d" /> Supersnel vergelijken
            </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <ShieldCheck size={20} strokeWidth={2} color="#15803d" /> Betrouwbaar & veilig
            </div>
            <div style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px', display: 'flex', alignItems: 'baseline' }}>
              <span style={{ color: '#15803d', fontWeight: 700, fontSize: '28px', lineHeight: 1 }}>E</span><span style={{ color: '#3b82f6', fontWeight: 700, fontSize: '24px', lineHeight: 1 }}>ch</span><span style={{ color: '#000', fontSize: '26px', lineHeight: 1, position: 'relative', top: '-2px' }}>●</span>
