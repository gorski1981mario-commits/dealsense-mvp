...
export type FlowType = 
  | 'scan'
  | 'configurator_insurance'
  | 'configurator_energy'
  | 'configurator_telecom'
  | 'configurator_vacation'
  | 'configurator_leasing'
  | 'configurator_mortgage'
  | 'configurator_loan'
  | 'configurator_creditcard'
  | 'configurator_subscriptions'
  | 'package_purchase'
  | 'referral'
  | 'bills_optimizer'
  | 'gold_investment'
